...
(function () {
            ...
            return {
                define: function (a, b) {
                    ...
                    if (0 > z.getListenerIndex(c)) {
                        ...
                        q.fn = c;
                        q.priority = l;
                        for (var x = z.length - 1; 0 <= x; x--) if (z[x].priority <= l) return z.splice(x + 1, 0, q), {removeListener: g};
                        z.unshift(q)
                    }
                    ...
                    return function (l, q, g) {
                        ...
                        if (y) {
                            ...
                            if (x.length) for (var x = x.slice(0),
                                                   E, v = 0; v < x.length; v++) {
                                if (y.errorProof) try {
                                    E = x[v].call(this, g, q, e, h)
                                } catch (n) {
                                } else E = x[v].call(this, g, q, e, h);
                                E === a ? d = 1 : "undefined" != typeof E && (q = E);
                                if (c || d) break
                            }
                        }
    ...
    (function () {
        ...
        var b = [], c = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "",
            f = /&/g, e = />/g, k = /</g, h = /"/g, l = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g,
            q = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"}, g = function (a, z) {
                return "#" == z[0] ? String.fromCharCode(parseInt(z.slice(1), 10)) : q[z]
            };
        ...
        CKEDITOR.tools = {
            ...
            getIndex: function (a, z) {
                for (var b = 0; b < a.length; ++b) if (z(a[b])) return b;
                return -1
            },
            clone: function (a) {
                var z;
                if (a && a instanceof Array) {
                    z = [];
                    for (var b = 0; b < a.length; b++) z[b] = CKEDITOR.tools.clone(a[b]);
                    return z
                }
            ...
            extend: function (a) {
                ...
                for (var h = 1; h < b; h++) {
                    ...
                    CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(n), function (b) {
                        if (!0 === c || null == a[b]) if (!g || b in g) a[b] = n[b]
                    })
                }
                return a
            },
            ...
            buildStyleHtml: function (a) {
                a = [].concat(a);
                for (var b, c = [], g = 0; g < a.length; g++) if (b = a[g]) /@import|[{}]/.test(b) ? c.push("\x3cstyle\x3e" + b + "\x3c/style\x3e") : c.push('\x3clink type\x3d"text/css" rel\x3dstylesheet href\x3d"' + b + '"\x3e');
                return c.join("")
            },
            htmlEncode: function (a) {
                return void 0 === a || null === a ? "" : String(a).replace(f, "\x26amp;").replace(e, "\x26gt;").replace(k, "\x26lt;")
            },
            ...
            transformPlainTextToHtml: function (a, b) {
                var c = b == CKEDITOR.ENTER_BR, g = this.htmlEncode(a.replace(/\r\n/g, "\n")),
                    g = g.replace(/\t/g, "\x26nbsp;\x26nbsp; \x26nbsp;"), h = b == CKEDITOR.ENTER_P ? "p" : "div";
                if (!c) {
                    var n = /\n{2}/g;
                    if (n.test(g)) var e = "\x3c" + h + "\x3e", d = "\x3c/" + h + "\x3e",
                        g = e + g.replace(n, function () {
                            return d + e
                        }) + d
                }
                g = g.replace(/\n/g, "\x3cbr\x3e");
                c || (g =
                    g.replace(new RegExp("\x3cbr\x3e(?\x3d\x3c/" + h + "\x3e)"), function (a) {
            ...
            indexOf: function (a, b) {
                if ("function" == typeof b) for (var c = 0, g = a.length; c < g; c++) {
                    if (b(a[c])) return c
                } else {
            ...
            createClass: function (a) {
                ...
                c && (b.prototype = this.prototypedCopy(c.prototype), b.prototype.constructor = b, b.base = c, b.baseProto = c.prototype, b.prototype.base = function u() {
            ...
            normalizeCssText: function (a, b) {
                var c = [], g, h = CKEDITOR.tools.parseCssText(a, !0, b);
            ...
            keystrokeToArray: function (a, b) {
                var c = b & 16711680, g = b & 65535, h = CKEDITOR.env.mac, n = [], e = [];
                c & CKEDITOR.CTRL && (n.push(h ? "⌘" : a[17]), e.push(h ? a[224] : a[17]));
                c & CKEDITOR.ALT && (n.push(h ? "⌥" : a[18]), e.push(a[18]));
                c & CKEDITOR.SHIFT && (n.push(h ? "⇧" : a[16]), e.push(a[16]));
                g && (a[g] ? (n.push(a[g]), e.push(a[g])) : (n.push(String.fromCharCode(g)), e.push(String.fromCharCode(g))));
                return {display: n, aria: e}
            },
            transparentImageData: "data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw\x3d\x3d",
            getCookie: function (a) {
                a = a.toLowerCase();
                for (var b = document.cookie.split(";"), c, g, h = 0; h < b.length; h++) if (c = b[h].split("\x3d"), g = decodeURIComponent(CKEDITOR.tools.trim(c[0]).toLowerCase()), g === a) return decodeURIComponent(1 < c.length ? c[1] : "");
                return null
            },
            ...
            escapeCss: function (a) {
                if (a) if (window.CSS && CSS.escape) a = CSS.escape(a); else {
                    a = String(a);
                    for (var b = a.length, c = -1, g, h = "", n = a.charCodeAt(0); ++c < b;) g = a.charCodeAt(c), h = 0 == g ? h + "�" : 127 == g || 1 <= g && 31 >= g || 0 == c && 48 <=
                    g && 57 >= g || 1 == c && 48 <= g && 57 >= g && 45 == n ? h + ("\\" + g.toString(16) + " ") : 0 == c && 1 == b && 45 == g ? h + ("\\" + a.charAt(c)) : 128 <= g || 45 == g || 95 == g || 48 <= g && 57 >= g || 65 <= g && 90 >= g || 97 <= g && 122 >= g ? h + a.charAt(c) : h + ("\\" + a.charAt(c));
                    a = h
                } else a = "";
                return a
            },
            ...
            normalizeMouseButton: function (a, b) {
                ...
                for (var c = [[CKEDITOR.MOUSE_BUTTON_LEFT, 1], [CKEDITOR.MOUSE_BUTTON_MIDDLE,
                    4], [CKEDITOR.MOUSE_BUTTON_RIGHT, 2]], g = 0; g < c.length; g++) {
                    var h = c[g];
            ...
            convertBytesToBase64: function (a) {
                var b = "", c = a.length, g;
                for (g = 0; g < c; g += 3) {
                    var h = a.slice(g, g + 3), n = h.length, e = [], d;
            ...
            object: {
                ...
                keys: function (a) {
                    var b = Object.prototype.hasOwnProperty, c = [], g = CKEDITOR.tools.object.DONT_ENUMS;
                    ...
                    if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version) for (h = 0; h < g.length; h++) b.call(a, g[h]) && c.push(g[h]);
                    return c
                },
                ...
                merge: function (a, b) {
                    var c = CKEDITOR.tools, g = c.clone(a), h = c.clone(b);
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
                ...
                table: 1,
                ul: 1
            }, e = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, k = {}, h = {"#": 1},
    ...
    (function (a) {
        ...
        a.removeCustomData = function (a) {
            var c = this.$["data-cke-expando"], c = c && d[c], f, e;
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
        type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function (a) {
            ...
            for (var b =
                ...
                var f = a[c];
                if (d) for (var e = -1, k = 0; k < b.childNodes.length; k++) {
                    var h = b.childNodes[k];
                    if (!0 !== d || 3 != h.nodeType || !h.previousSibling || 3 != h.previousSibling.nodeType) if (e++, e == f) {
                        b = h;
                        break
                    }
    ...
    CKEDITOR.dom.element.clearMarkers = function (a, d, b) {
        var c = d.getCustomData("list_marker_names"), f = d.getCustomData("list_marker_id"), e;
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () {
                ...
                function a(b, c, g) {
                    if (c && c.type == CKEDITOR.NODE_ELEMENT) {
                        for (var d =
                            []; c.data("cke-bookmark") || c.isEmptyInlineRemoveable();) if (d.push(c), c = g ? c.getNext() : c.getPrevious(), !c || c.type != CKEDITOR.NODE_ELEMENT) return;
                        if (b.isIdentical(c)) {
                ...
                if (b.removeProperty || "border" != a && "margin" != a && "padding" != a) b.removeProperty ? b.removeProperty(a) : b.removeAttribute(CKEDITOR.tools.cssStyleToDomStyle(a)), this.$.style.cssText || this.removeAttribute("style"); else {
                    ...
                    for (var b = [], d = 0; d < c.length; d++) if (g) for (var e =
                        0; e < g.length; e++) b.push([a, c[d], g[e]].join("-")); else b.push([a, c[d]].join("-"));
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var f = this.$.getBoundingClientRect(), k = g.$.documentElement,
                        v = k.clientTop || d.$.clientTop || 0, n = k.clientLeft || d.$.clientLeft || 0, H = !0;
                    CKEDITOR.env.ie && (H = g.getDocumentElement().contains(this), g = g.getBody().contains(this), H = e && g || !e && H);
                    H && (CKEDITOR.env.webkit || CKEDITOR.env.ie && 12 <= CKEDITOR.env.version ? (b = d.$.scrollLeft || k.scrollLeft, c = d.$.scrollTop || k.scrollTop) : (c = e ? d.$ : k, b = c.scrollLeft, c = c.scrollTop), b = f.left + b - n, c = f.top + c - v)
                ...
                e = a.getWindow();
                d = v(this, e);
                var u = v(a, e), I = this.$.offsetHeight;
                g = this.$.offsetWidth;
                var J = a.$.clientHeight, m = a.$.clientWidth;
                e = d.x - n(this, "left") - u.x || 0;
                f = d.y - n(this, "top") - u.y || 0;
                g = d.x + g + n(this, "right") - (u.x + m) || 0;
                d = d.y + I + n(this, "bottom") - (u.y + J) || 0;
            ...
            getFrameDocument: function () {
                ...
                for (var g = 0; g < c.length; g++) {
                    ...
                    if (!(e in b)) if ("checked" == e && (f = this.getAttribute(e))) a.setAttribute(e, f); else if (!CKEDITOR.env.ie || this.hasAttribute(e)) f = this.getAttribute(e), null === f && (f = d.nodeValue), a.setAttribute(e, f)
                }
                "" !== this.$.style.cssText &&
                ...
                if (CKEDITOR.env.ie && 9 > CKEDITOR.env.version) {
                    var d = g.ownerDocument.createEventObject(), e;
                    for (e in b) d[e] = b[e];
                    g.fireEvent(c,
                        d)
                } else g[g[a] ? a : c](b)
    ...
    (function () {
        function a(a, b) {
            ...
            g = c.endContainer;
            var e = c.startOffset, f = c.endOffset, y, h = this.guard, m = this.type,
                k = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var K = g.type == CKEDITOR.NODE_ELEMENT ? g : g.getParent(),
                    A = g.type == CKEDITOR.NODE_ELEMENT ? g.getChild(f) : g.getNext();
            ...
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function (a, b) {
                    return (!b || !q.equals(a)) && (!r || !a.equals(r)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            ...
            this.current ? g = this.current[k](!1, m, y) : (a ? g.type == CKEDITOR.NODE_ELEMENT &&
                (g = 0 < f ? g.getChild(f - 1) : !1 === y(g, !0) ? null : g.getPreviousSourceNode(!0, m, y)) : (g = d, g.type == CKEDITOR.NODE_ELEMENT && ((g = g.getChild(e)) || (g = !1 === y(d, !0) ? null : d.getNextSourceNode(!0, m, y)))), g && !1 === y(g) && (g = null));
            for (; g && !this._.end;) {
                this.current = g;
        ...
        var f = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, e = CKEDITOR.dom.walker.whitespaces(),
            k = CKEDITOR.dom.walker.bookmark(), h = CKEDITOR.dom.walker.temp(), l = function (a) {
        ...
        CKEDITOR.dom.walker.empty = function (a) {
            return function (b) {
                for (var c = 0, g = b.getChildCount(); c < g; ++c) if (!q(b.getChild(c))) return !!a;
                return !a
            }
        };
        ...
        CKEDITOR.dom.walker.editable = function (a) {
            return function (b) {
                b =
                    q(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(y) && g(b)) ? !0 : !1;
                return !!(a ^ b)
            }
        };
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            function f(a, b, c, g) {
                var F = c ? a.getPrevious() : a.getNext();
                if (g && k) return F;
                l || g ? b.append(a.clone(!0, e), c) : (a.remove(), q && b.append(a, c));
                return F
            }

            function n() {
                var a, b, c, g = Math.min(S.length, t.length);
                for (a = 0; a < g; a++) if (b = S[a], c = t[a], !b.equals(c)) return a;
                return a - 1
            }

            function h() {
                var b = O - 1, c = B && D && !m.equals(C);
                b < N - 1 || b < p - 1 || c ? (c ? a.moveToPosition(C,
            ...
            b = l || q;
            var m = a.startContainer, C = a.endContainer,
                K = a.startOffset, A = a.endOffset, L, r, B, D, w, Q;
            if (l && C.type == CKEDITOR.NODE_TEXT && (m.equals(C) || m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(C))) c.append(a.document.createText(C.substring(K, A))); else {
                C.type == CKEDITOR.NODE_TEXT ? l ? Q = !0 : C = C.split(A) : 0 < C.getChildCount() ? A >= C.getChildCount() ? (C = C.getChild(A - 1), r = !0) : C = C.getChild(A) : D = r = !0;
                m.type == CKEDITOR.NODE_TEXT ? l ? w = !0 : m.split(K) : 0 < m.getChildCount() ? 0 === K ? (m = m.getChild(K), L = !0) : m = m.getChild(K - 1) : B = L = !0;
                for (var S = m.getParents(), t = C.getParents(), O = n(),
                         N = S.length - 1, p = t.length - 1, G = c, F, da, aa, fa = -1, U = O; U <= N; U++) {
                    da = S[U];
                    aa = da.getNext();
                    for (U != N || da.equals(t[U]) && N < p ? b && (F = G.append(da.clone(0, e))) : L ? f(da, G, !1, B) : w && G.append(a.document.createText(da.substring(K))); aa;) {
                        if (aa.equals(t[U])) {
                            fa = U;
                            break
                        }
                ...
                G = c;
                for (U = O; U <= p; U++) if (c = t[U], aa = c.getPrevious(), c.equals(S[U])) b && (G = G.getChild(0)); else {
                    U != p || c.equals(S[U]) && p < N ? b && (F = G.append(c.clone(0, e))) : r ? f(c, G, !1, D) : Q && G.append(a.document.createText(c.substring(0, A)));
                    if (U > fa) for (; aa;) aa = f(aa,
                        G, !0);
                    G = F
                }
                l || h()
        ...
        CKEDITOR.dom.range.prototype =
            {
                clone: function () {
                    ...
                    var c = this.startContainer, d = this.endContainer, e = this.collapsed, f, n, h, k;
                    ...
                    e || (n = f.clone(), n.setHtml("\x26nbsp;"), a && n.setAttribute("id", h + "E"), k = this.clone(), b(d) && (d = b(d),
                    ...
                    k.collapse(!0);
                    k.insertNode(f);
                    n ? (this.setStartAfter(f), this.setEndBefore(n)) : this.moveToPosition(f, CKEDITOR.POSITION_AFTER_END);
                    return {
                    ...
                    function a(b) {
                        var g = b.container, d = b.offset, e;
                        e = g;
                        var f = d;
                    ...
                    switch (a) {
                        ...
                        case CKEDITOR.ENLARGE_ELEMENT:
                            var f = function (a, b) {
                                ...
                                for (c.guard =
                                    ...
                                    L = g != a ? g.getText() : g.substring(b);
                                    if (d.test(L)) return !1
                                }
                                return !0
                            };
                            if (this.collapsed) break;
                            var n = this.getCommonAncestor(), h = this.root, k, q, l, m, C, K = !1, A, L;
                            ...
                            for (l = c(l); l || m;) {
                                ...
                                for (; m;) if (A = !1, m.type == CKEDITOR.NODE_COMMENT) m = m.getPrevious(); else {
                                    if (m.type == CKEDITOR.NODE_TEXT) L = m.getText(), d.test(L) && (m = null), A = /[\s\ufeff]$/.test(L); else if ((m.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && m.is("br")) && !m.data("cke-bookmark")) if (K && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                        L = m.getText();
                                        if (d.test(L)) m = null; else for (var r = m.$.getElementsByTagName("*"), B = 0, D; D = r[B++];) if (!CKEDITOR.dtd.$removeEmpty[D.nodeName.toLowerCase()]) {
                                            m = null;
                                            break
                                        }
                                        m && (A = !!L.length)
                            ...
                            A.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(A.substring(r)).length ? K = !0 : (K = !A.getLength(), r == A.getLength() ? (m = A.getNext()) || (l = A.getParent()) :
                                f(A, r) && (l = A.getParent())) : (m = A.getChild(r)) || (l = A);
                            for (; l || m;) {
                                if (l && !m) {
                                    !C && l.equals(n) && (C = !0);
                                    if (e ? l.isBlockBoundary() : !h.contains(l)) break;
                                    K && "inline" == l.getComputedStyle("display") || (K = !1, C ? q = l : l && this.setEndAfter(l));
                                    m = l.getNext()
                                }
                                for (; m;) {
                                    A = !1;
                                    if (m.type == CKEDITOR.NODE_TEXT) L = m.getText(), f(m, 0) || (m = null), A = /^[\s\ufeff]/.test(L); else if (m.type == CKEDITOR.NODE_ELEMENT) {
                                        if ((0 < m.$.offsetWidth || b && m.is("br")) && !m.data("cke-bookmark")) if (K && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
                                            L = m.getText();
                                            if (d.test(L)) m =
                                                null; else for (r = m.$.getElementsByTagName("*"), B = 0; D = r[B++];) if (!CKEDITOR.dtd.$removeEmpty[D.nodeName.toLowerCase()]) {
                                                m = null;
                                                break
                                            }
                                            m && (A = !!L.length)
                            ...
                            k && q && (n = k.contains(q) ? q : k, this.setStartBefore(n), this.setEndAfter(n));
                            break;
                        ...
                        case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                            ...
                            if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                                l = this.clone();
                                l = new CKEDITOR.dom.walker(l);
                                var N = CKEDITOR.dom.walker.whitespaces(), p = CKEDITOR.dom.walker.bookmark();
                    ...
                    if (!this.collapsed) {
                        ...
                        var f = this.clone(), n = this.startContainer, h = this.endContainer, k = this.startOffset,
                            l = this.endOffset,
                            q = c = 1;
                        n && n.type == CKEDITOR.NODE_TEXT && (k ? k >= n.getLength() ? f.setStartAfter(n) : (f.setStartBefore(n), c = 0) : f.setStartBefore(n));
                        h && h.type == CKEDITOR.NODE_TEXT && (l ? l >= h.getLength() ? f.setEndAfter(h) : (f.setEndAfter(h), q = 0) : f.setEndBefore(h));
                        var f = new CKEDITOR.dom.walker(f), m = CKEDITOR.dom.walker.bookmark(),
                        ...
                        c && (n = f[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(n, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
                    ...
                    var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root),
                        d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, f = d.block,
                        n = null;
                    ...
                    this.deleteContents();
                    e && e.equals(f) && (d ? (n = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_AFTER_END), f = null) : c ? (n = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(e, CKEDITOR.POSITION_BEFORE_START), e = null) : (f = this.splitElement(e, b ||
                        !1), e.is("ul", "ol") || e.appendBogus()));
                    return {previousBlock: e, nextBlock: f, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: n}
                    ...
                    for (var c = 0; a;) {
                        ...
                        d.type == CKEDITOR.NODE_ELEMENT && d.isEditable(!1) && (f = d[b ? "getLast" : "getFirst"](q));
                        e || f || (f = d[b ? "getPrevious" : "getNext"](q));
                        a = f
                    }
                    return !!c
                }, moveToClosestEditablePosition: function (a, b) {
                    var c, d = 0, e, f, n = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
                ...
                moveToElementEditEnd: function (a) {
                    ...
                    function a(b, c) {
                        var d = CKEDITOR.tools.array.map(b, function (a) {
                            return a
                        }), e = new CKEDITOR.dom.range(c.root), g, f, h;
                    ...
                    return void 0 !== this.document.getSelection ? function (d) {
                        var e = this.root.getDocument().$.createRange(), f;
                    ...
                    var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), e = [], f, n, h, k;
                    if (c && c.find) for (n = c.find(a), f = 0; f < n.count(); f++) if (c = n.getItem(f), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), k = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    k = v.startPath();
                    var n = v.endPath(), H = !v.collapsed && c(v, k.block), u = !v.collapsed && c(v, n.block, 1);
                    v.shrink(CKEDITOR.SHRINK_ELEMENT, !0);
                    H && v.setStartAt(k.block, CKEDITOR.POSITION_BEFORE_END);
                    u && v.setEndAt(n.block, CKEDITOR.POSITION_AFTER_START);
                    ...
                    (n = new CKEDITOR.dom.elementPath(n.endContainer, n.root), this._.lastNode = (n.block || n.blockLimit).getNextSourceNode(!0))), this._.lastNode && v.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = v.document.createText(""), this._.lastNode.insertAfter(k)), v = null);
                    this._.started = 1;
                    k = v
                }
                n = this._.nextNode;
                ...
                for (this._.nextNode = null; n;) {
                    var H = 0, u = n.hasAscendant("pre"), I = n.type != CKEDITOR.NODE_ELEMENT, J = 0;
                    if (I) n.type == CKEDITOR.NODE_TEXT && f.test(n.getText()) && (I = 0); else {
                        var m = n.getName();
                        if (CKEDITOR.dtd.$block[m] && "false" == n.getAttribute("contenteditable")) {
                            d = n;
                            b(this, a, d);
                            break
                        } else if (n.isBlockBoundary(this.forceBrBreak && !u && {br: 1})) {
                            if ("br" == m) I = 1; else if (!k && !n.getChildCount() && "hr" != m) {
                                d = n;
                                z = n.equals(v);
                                break
                            }
                    ...
                    z = (!H || I) && n.equals(v);
                    if (k && !H) for (; !n.getNext(h) && !z;) {
                        m = n.getParent();
                        if (m.isBlockBoundary(this.forceBrBreak && !u && {br: 1})) {
                            H = 1;
                            I = 0;
                            z || m.equals(v);
                    ...
                    I && k.setEndAt(n, CKEDITOR.POSITION_AFTER_END);
                    n = this._getNextSourceNode(n, J, v);
                    if ((z = !n) || H && k) break
                }
                if (!d) {
                ...
                E && (x = d.getLast()) && x.type == CKEDITOR.NODE_ELEMENT && "br" == x.getName() && (!CKEDITOR.env.needsBrFiller || x.getPrevious(e) || x.getNext(e)) && x.remove();
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            for (f in b) {
                g = b[f];
                g = "boolean" == typeof g ? {} : "function" == typeof g ? {match: g} : B(g);
                ...
                for (r in Q) {
                    m[r] = k(m[r], p) || null;
                    var D = m, n = S[r], t = k(m[S[r]], p), h = m[r], w = [], G = !0, O = void 0;
                    t ? G = !1 : t = {};
                    for (O in h) "!" == O.charAt(0) && (O = O.slice(1), w.push(O), t[O] = !0, G = !1);
                    for (; O = w.pop();) h[O] =
                        h["!" + O], delete h["!" + O];
                    D[n] = (G ? !1 : t) || null
                }
            ...
            for (d = a.length; c < d; ++c) {
                ...
                for (r in S) {
                    ...
                    t = [];
                    h = void 0;
                    for (h in n) -1 < h.indexOf("*") ? t.push(new RegExp("^" + h.replace(/\*/g, ".*") + "$")) : t.push(h);
                    n = t;
                    n.length && (m[p] = n, D = !1)
                }
                m.nothingRequired = D;
        ...
        function g(a) {
            var b, c, d, e, f = {}, g = 1;
            for (a = D(a); b = a.match(t);) (c = b[2]) ? (d = y(c, "styles"), e = y(c, "attrs"), c = y(c, "classes")) : d = e = c = null, f["$" + g++] = {
                elements: b[1],
                classes: c,
                styles: d,
                attributes: e
        ...
        function x(a, b, e, f) {
            ...
            if (f.doCallbacks && a.elementCallbacks) {
                a:{
                    ...
                    for (var t = 0, D = r.length, k; t < D; ++t) if (k = r[t](b)) {
                        r = k;
                        break a
                    }
                    r = void 0
            ...
            if (f.doFilter) {
                a:{
                    ...
                    if (a || r) {
                        z(b);
                        if (t) for (w = 0, B = t.length; w < B; ++w) if (!1 === c(t[w], b, h)) {
                            a = null;
                            break a
                        }
                        if (D) for (w = 0, B = D.length; w < B; ++w) c(D[w], b, h);
                        if (a) for (w = 0, B = a.length; w < B; ++w) d(a[w], b, h, k);
                        if (r) for (w = 0, B = r.length; w < B; ++w) d(r[w], b, h, k);
                        a = h
                    } else a = null
                }
                ...
                var O = a.validStyles;
                r = a.validClasses;
                var t = b.attributes, G = b.styles, D = b.classes;
                k = b.classBackup;
                var C = b.styleBackup, A, l, K = [], h = [], Q = /^data-cke-/;
                w = !1;
                delete t.style;
                delete t["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes) for (A in t) B[A] || (Q.test(A) ? A == (l = A.replace(/^data-cke-saved-/, "")) || B[l] || (delete t[A], w = !0) : (delete t[A], w = !0));
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (A in G) a.allStyles || O[A] ? K.push(A + ":" + G[A]) : w = !0;
                    K.length && (t.style = K.sort().join("; "))
                } else C && (t.style = C);
                if (!a.allClasses ||
                    a.hadInvalidClass) {
                    for (A = 0; A < D.length; ++A) (a.allClasses || r[D[A]]) && h.push(D[A]);
                    h.length && (t["class"] = h.sort().join(" "));
                    k && h.length < k.split(/\s+/).length && (w = !0)
                } else k && (t["class"] = k);
                w && (g = 1);
        ...
        function J(a, b, c) {
            var d = a.name;
            if (r.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(u()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (r.$block[d] || "tr" == d) if ("br" == b) a.previous && !I(a.previous) && (b = u(), b.insertBefore(a)), a.next && !I(a.next) && (b = u(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, e;
                b:{
                    e = r[b];
                ...
                if (e) a.name = b, a.attributes =
                    ...
                    e = a.parent;
                    for (var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, p, t, g = d.length; 0 < g;) m = d[--g], f && (m.type == CKEDITOR.NODE_TEXT || m.type == CKEDITOR.NODE_ELEMENT && r.$inline[m.name]) ? (p || (p = new CKEDITOR.htmlParser.element(b), p.insertAfter(a), c.push({
                        check: "parent-down",
                        el: p
                    })), p.add(m, 0)) : (p = null, t = r[e.name] || r.span, m.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || m.type != CKEDITOR.NODE_ELEMENT || t[m.name] || c.push({
                        check: "el-up",
                        el: m
                    }));
                    a.remove()
        ...
        function C(a, b) {
            var c = b.getDefinition(), d = c.attributes, e = c.styles, f, g, m, p;
            if (a.name != c.element) return !1;
            for (f in d) if ("class" == f) for (c = d[f].split(/\s+/), m = a.classes.join("|"); p = c.pop();) {
                if (-1 == m.indexOf(p)) return !1
            } else if (a.attributes[f] != d[f]) return !1;
            for (g in e) if (a.styles[g] !=
                e[g]) return !1;
            return !0
        }
        ...
        var r = CKEDITOR.dtd, B = CKEDITOR.tools.copy, D = CKEDITOR.tools.trim, w = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, f = [], g = this.editor && this.editor.config.protectedSource, m, p = !1,
                    t = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"]) return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if (m = x(e, a, f, t), m & 1) p = !0; else if (m & 2) return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var r, D, n;
                            if (g) for (D = 0; D < g.length; ++D) if ((n = d.match(g[D])) && n[0].length == d.length) {
                                c =
                                    !0;
                                break a
                            }
                ...
                for (var k; c = f.pop();) c.type == CKEDITOR.NODE_ELEMENT ? J(c, d, a) : c.remove();
                for (; D = a.pop();) if (c = D.el, c.parent) switch (k = r[c.parent.name] || r.span, D.check) {
                    case "it":
                        r.$removeEmpty[c.name] && !c.children.length ? J(c, d, a) : n(c) || J(c, d, a);
                        break;
                    case "el-up":
                        c.parent.type ==
                        CKEDITOR.NODE_DOCUMENT_FRAGMENT || k[c.name] || J(c, d, a);
                        break;
                    case "parent-down":
                        c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || k[c.name] || J(c.parent, d, a)
                }
                return p
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        b = a[e];
                        var f = void 0, g = void 0, m = void 0, p = void 0, t = void 0, r = void 0;
                        c = [];
                        for (g = 0; g < b.length; ++g) m = b[g], "string" == typeof m ? (m = m.split(/\s*:\s*/), p = m[0], t = null, r = m[1]) : (p = m.check, t = m.left, r = m.right), f || (f = m, f = f.element ? f.element : p ? p.match(/^([a-z0-9]+)/i)[0] :
                            f.left.getDefinition().element), t instanceof CKEDITOR.style && (t = A(t)), c.push({
                            check: p == f ? null : p,
                            left: t,
                            right: "string" == typeof r ? L(r) : r
                        });
                        b = f;
                        d[b] || (d[b] = []);
                        d[b].push(c)
                ...
                if ("string" == typeof a) {
                    ...
                    e = g(a).$1;
                    var p = e.styles, d = e.classes;
                    e.name = e.elements;
                    e.classes = d = d ? d.split(/\s*,\s*/) : [];
                    e.styles = q(p);
                    e.attributes = q(e.attributes);
                    e.children = [];
                    d.length && (e.attributes["class"] = d.join(" "));
                    p && (e.attributes.style = CKEDITOR.tools.writeCssText(e.styles))
                } else e = a.getDefinition(), p = e.styles, d = e.attributes || {}, p && !CKEDITOR.tools.isEmpty(p) ? (p = B(p), d.style = CKEDITOR.tools.writeCssText(p, !0)) : p = {}, e = {
                    name: e.element,
                    attributes: d,
                ...
                var p = CKEDITOR.tools.clone(e), t = [], r;
                if (!1 !== b && (r = this._.transformations[e.name])) {
                    for (d =
                             0; d < r.length; ++d) m(this, e, r[d]);
                    v(e)
                }
                x(this, p, t, {doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c});
                0 < t.length ? c = !1 : ((b = e.attributes["class"]) && (e.attributes["class"] = e.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(e.attributes, p.attributes, !0), b && (e.attributes["class"] = b));
        ...
        var Q = {styles: 1, attributes: 1, classes: 1},
            ...
            O = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, N = /^cke:(object|embed|param)$/,
            p = /^(object|embed|param)$/, G;
        G = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, e = c.attributes, f, g, m, p;
                    a.name = c.element;
                    for (f in e) if ("class" ==
                        f) for (c = a.classes.join("|"), m = e[f].split(/\s+/); p = m.pop();) -1 == c.indexOf(p) && a.classes.push(p); else a.attributes[f] = e[f];
    ...
    (function () {
        var a, d = function (b) {
            b = b.data;
            var d = b.getKeystroke(), e = this.keystrokes[d], k = this._.editor;
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, f, e) {
                ...
                k && (b = [b]);
                f || (f = CKEDITOR);
                var h = b.length, l = h, q = [], g = [], y = function (a) {
                    c && (k ? c.call(f, a) : c.call(f, q, g))
                };
                if (0 === l) y(!0); else {
                    var z = function (a, b) {
                        (b ? q : g).push(a);
                        0 >= --l && (e && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), y(b))
                    }, x = function (b, c) {
                        a[b] = 1;
                        var e = d[b];
                        delete d[b];
        ...
        add: function (a, d) {
            ...
            CKEDITOR.scriptLoader.load(e,
                function (a, e) {
                    ...
                    for (var f = 0; f < a.length; f++) for (var g = k[a[f]], l = 0; l < g.length; l++) {
                        var n = g[l];
                        h[n] = this.get(n);
                        c[n] = 1
                    }
        ...
        return function (b, c, f) {
            var e = {}, k = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], g;
                    for (g in a) {
                        var h = a[g], z = h && h.requires;
                        if (!d[g]) {
                            if (h.icons) for (var x = h.icons.split(","), E = x.length; E--;) CKEDITOR.skin.addIcon(x[E], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + x[E] + ".png");
    ...
    (function () {
        ...
        function y(a) {
            ...
            CKEDITOR.plugins.load(d.split(","),
                function (b) {
                    ...
                    for (var g in b) {
                        var m = b[g], k = m.lang, C = null, t = m.requires, O;
                        CKEDITOR.tools.isArray(t) && (t = t.join(","));
                        if (t && (O = t.match(h))) for (; t = O.pop();) CKEDITOR.error("editor-plugin-required", {
                            plugin: t.replace(",", ""),
                            requiredBy: g
                        });
                        k && !a.lang[g] && (k.split && (k = k.split(",")), 0 <= CKEDITOR.tools.indexOf(k, a.langCode) ? C = a.langCode : (C = a.langCode.replace(/-.*/, ""), C = C != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, C) ? C : 0 <= CKEDITOR.tools.indexOf(k,
                            "en") ? "en" : k[0]), m.langEntries && m.langEntries[C] ? (a.lang[g] = m.langEntries[C], C = null) : f.push(CKEDITOR.getUrl(m.path + "lang/" + C + ".js")));
                        e.push(C);
                        d.push(m)
                    }
        ...
        function x(a, b) {
            ...
            for (var e = new CKEDITOR.dom.documentFragment, f, g, h, k = 0; k < a.length; k++) {
                ...
                c(l) ? (f || (f = r.getAscendant("table").clone(), f.append(r.getAscendant({
                        ...
                        tbody: 1,
                        tfoot: 1
                    }).clone()), e.append(f), f = f.findOne("thead, tbody, tfoot")), g && g.equals(r) || (g = r, h = r.clone(), f.append(h)), h.append(d(l))) :
        ...
        CKEDITOR.editor.initializeDelayedEditorCreation = function (a, b, c) {
            if (b.delayIfDetached_callback) CKEDITOR.warn("editor-delayed-creation",
                {method: "callback"}), b.delayIfDetached_callback(function () {
                CKEDITOR[c](a, b);
                ...
                e = setInterval(function () {
                    a.isDetached() || (clearInterval(e), CKEDITOR[c](a, b), CKEDITOR.warn("editor-delayed-creation-success", {method: "interval - " + d + " ms"}))
                }, d)
            }
        };
        ...
        CKEDITOR.editor.mergeDelayedCreationConfigs = function (a) {
            a && (a.delayIfDetached = "boolean" === typeof a.delayIfDetached ? a.delayIfDetached : CKEDITOR.config.delayIfDetached, a.delayIfDetached_interval = isNaN(a.delayIfDetached_interval) ? CKEDITOR.config.delayIfDetached_interval : a.delayIfDetached_interval, a.delayIfDetached_callback = a.delayIfDetached_callback || CKEDITOR.config.delayIfDetached_callback)
        }
    })();
        ...
        CKEDITOR.htmlParser.prototype = {
            onTagOpen: function () {
                ...
                for (var c, f, e = 0, k; c = this._.htmlPartsRegex.exec(b);) {
                    f = c.index;
                    if (f > e) if (e = b.substring(e, f), k) k.push(e); else this.onText(e);
        ...
        CKEDITOR.htmlParser.cdata.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            filter: function (a) {
                ...
                if (d && d.getAscendant({math: 1, svg: 1})) {
                    var d = CKEDITOR.htmlParser.fragment.fromHtml(this.value), b = new CKEDITOR.htmlParser.basicWriter;
                    a.applyTo(d);
                    d.writeHtml(b);
            ...
            function (e, k, h) {
                function l(a) {
                    ...
                    if (0 < n.length) for (var c = 0; c < n.length; c++) {
                        var d = n[c], e = d.name, f = CKEDITOR.dtd[e], g = u.name && CKEDITOR.dtd[u.name];
                        g && !g[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == u.name && (y(u, u.parent, 1), c--) : (b || (q(), b = 1), d = d.clone(), d.parent = u, u = d, n.splice(c, 1), c--)
                    }
                }
                ...
                function y(b, c, d) {
                    c = c || u || v;
                    var e = u;
                    void 0 === b.previous && (z(c, b) && (u = c, E.onTagOpen(h, {}), b.returnPoint = c = u), g(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (J = !1), "textarea" == b.name && (I = !1));
                ...
                var E = new CKEDITOR.htmlParser,
                    ...
                    n = [], H = [], u = v, I = "textarea" == v.name, J = "pre" == v.name;
                    ...
                    if (a(f)) n.push(f); else {
                        ...
                        if ("br" == e) H.push(f); else {
                            for (; !(h = (g = u.name) ? CKEDITOR.dtd[g] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || u.isUnknown || h[e]);) if (u.isOptionalClose) E.onTagClose(g); else if (e in b && g in b) g = u.children, (g = g[g.length - 1]) && "li" == g.name || y(g = new CKEDITOR.htmlParser.element("li"), u), !f.returnPoint && (f.returnPoint = u), u = g; else if (e in CKEDITOR.dtd.$listItem &&
                                !x(e, g)) E.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !x(e, g)) !f.returnPoint && (f.returnPoint = u), u = u.parent; else if (g in CKEDITOR.dtd.$inline && n.unshift(u), u.parent) y(u, u.parent, 1); else {
                                f.isOrphan = 1;
                                break
                            }
                            l(e);
                ...
                E.onTagClose = function (a) {
                    ...
                    for (var c = [], d = [], e = u; e != v && e.name != a;) e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent;
                    if (e != v) {
                ...
                E.onText = function (a) {
                    if (!(u._.hasInlineStarted && !H.length || J || I) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return;
                    var b = u.name,
                        e = b ? CKEDITOR.dtd[b] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                    if (!I && !e["#"] && b in d) E.onTagOpen(f[b] || ""), E.onText(a); else {
                        q();
                        l();
                        J || I || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
                        a = new CKEDITOR.htmlParser.text(a);
                        if (z(u, a)) this.onTagOpen(h, {}, 0, 1);
                        u.add(a)
                    }
                };
                E.onCDATA =
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment,
                    e = Array.prototype.slice.call(arguments, 1), k = this.rules, h = k.length, l, q, g, y;
                for (y = 0; y < h; y++) if (d && (l = c.type, q = c.name), g = k[y], !(a.nonEditable && !g.options.applyToAll ||
                    a.nestedEditable && g.options.excludeNestedEditable)) {
                    g = g.value.apply(null, e);
                    if (!1 === g || d && g && (g.name != q || g.type != l)) return g;
                    null != g && (e[0] = c = g)
                }
                return c
    ...
    (function () {
        function a(a, d) {
            ...
            function t(a, d) {
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var p = [], m = b(f), t, D;
                        if (m) for (r(m, 1) && p.push(m); m;) e(m) && (t = c(m)) && r(t) && ((D = c(t)) && !e(D) ? p.push(t) : (g(h).insertAfter(t), t.remove())), m = m.previous;
                        for (m = 0; m < p.length; m++) p[m].remove();
                        if (p = !a || !1 !== ("function" == typeof d ? d(f) : d)) h || CKEDITOR.env.needsBrFiller ||
                        f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ? h || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || f.name in CKEDITOR.dtd.tr || f.name in CKEDITOR.dtd.$listItem) ? (p = b(f), p = !p || "form" == f.name && "input" == p.name) : p = !1 : p = !1;
                        p && f.add(g(a))
                    }
                }
            }
            ...
            var D = {elements: {}}, h = "html" == d, w = CKEDITOR.tools.extend({}, m), B;
            for (B in w) "#" in I[B] || delete w[B];
            for (B in w) D.elements[B] = t(h, a.config.fillEmptyBlocks);
            D.root = t(h, !1);
        ...
        function v(a, b) {
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, e) {
                return "\x3c" + c + d + "\x3e" + E(x(e), b) + "\x3c/" + c + "\x3e"
            })
        }
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            e.addRules(A);
            e.addRules(L, {applyToAll: !0});
            e.addRules(a(b, "html"), {applyToAll: !0});
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, e, c = n(c), c = v(c, b), c = g(c, Q), c = q(c), c = g(c, w),
                    c = c.replace(t, "$1cke:$2"), c = c.replace(N, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
                    c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"),
                    c = c.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi, "$1data-cke-" + CKEDITOR.rnd + "-$2");
                e = a.context || b.editable().getName();
                var f;
                CKEDITOR.env.ie && 9 > CKEDITOR.env.version && "pre" == e && (e = "div", c = "\x3cpre\x3e" + c + "\x3c/pre\x3e", f = 1);
                ...
                e && (f = c, !f.children.length && CKEDITOR.dtd[f.name][e] && (e = new CKEDITOR.htmlParser.element(e), f.add(e)));
                a.dataValue = c
            }, null, null, 5);
            b.on("toHtml", function (a) {
        ...
        CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                ...
                return E(a, this.editor)
            }, unprotectRealComments: function (a) {
                return x(a)
            }
        };
        var H =
                /(?:&nbsp;|\xa0)$/, u = "{cke_protected}", I = CKEDITOR.dtd,
            J = "caption colgroup col thead tfoot tbody".split(" "),
            m = CKEDITOR.tools.extend({}, I.$blockLimit, I.$block), C = {elements: {input: h, textarea: h}}, K = {
                ...
                elements: {
                    $: function (a) {
                        ...
                        a.children.slice(0).sort(function (a, b) {
                            var c, d;
                            a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type && (c = CKEDITOR.tools.indexOf(J, a.name), d = CKEDITOR.tools.indexOf(J, b.name));
        ...
        CKEDITOR.env.ie && (L.attributes.style = function (a) {
            return a.replace(/(^|;)([^\:]+)/g, function (a) {
                return a.toLowerCase()
            })
        });
        var r = /<(a|area|img|input|source)\b([^>]*)>/gi,
            B = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, D = /^(href|src|name)$/i,
            ...
            O = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, N = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi;
        n = function () {
            function a(b, c) {
            ...
            function b(a) {
                return CKEDITOR.tools.array.reduce(a.split(""), function (a, b) {
                    var d = b.toLowerCase(), e = b.toUpperCase(), f = c(d);
                    d !== e && (f += "|" + c(e));
                    return a + ("(" + f + ")")
                }, "")
            }
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var l, q;
                for (l in k) {
                    for (h = k[l]; ;) if (q = a.onAttributeName(b, l)) if (q != l) delete k[l], l = q; else break; else {
                        delete k[l];
                        break
                    }
                ...
                b && this.filter(b);
                var e = this.name, k = [], h = this.attributes, l, q;
                a.openTag(e, h);
                for (l in h) k.push([l, h[l]]);
                a.sortAttributes && k.sort(d);
                l = 0;
                for (q = k.length; l < q; l++) h = k[l], a.attribute(h[0], h[1]);
                ...
                var d = null, k = CKEDITOR.tools.array.find(this.children, function (h) {
    ...
    (function () {
        CKEDITOR.inline = function (a, d) {
            ...
            if (!a) return null;
            if (CKEDITOR.editor.shouldDelayEditorCreation(a, d)) return CKEDITOR.editor.initializeDelayedEditorCreation(a, d, "inline"), null;
            var b = a.is("textarea") ? a : null, c = b ? b.getValue() : a.getHtml(),
        ...
        CKEDITOR.inlineAll = function () {
            var a, d, b;
            for (b in CKEDITOR.dtd.$editable) for (var c = CKEDITOR.document.getElementsByTag(b), f = 0, e = c.count(); f < e; f++) a = c.getItem(f), "true" != a.getAttribute("contenteditable") || a.getEditor() || (d = {
                element: a,
                config: {}
    ...
    (function () {
        function a(a, f, e, k) {
            a = CKEDITOR.editor._getEditorElement(a);
            if (!a) return null;
            if (CKEDITOR.editor.shouldDelayEditorCreation(a, f)) return CKEDITOR.editor.initializeDelayedEditorCreation(a, f, "replace"), null;
        ...
        function b(a) {
            var b = a.name, d =
                    a.element, k = a.elementMode, h = a.fire("uiSpace", {space: "top", html: ""}).html,
        ...
        CKEDITOR.editor.prototype.setMode = function (a, b) {
            ...
            if (a != d.mode && k && k[a]) {
                ...
                if (d.mode) {
                    var h = d.checkDirty(), k = d._.previousModeData, l, q = 0;
                    d.fire("beforeModeUnload");
                    d.editable(0);
                    d._.previousMode = d.mode;
                    d._.previousModeData = l = d.getData(1);
                    "source" == d.mode && k == l && (d.fire("lockSnapshot", {forceUpdate: !0}), q = 1);
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, k) {
            var h =
                    this.container, l = this.ui.space("contents"),
            ...
            var g = (k.$.offsetHeight || 0) - (l.$.clientHeight || 0), h = Math.max(b - (d ? 0 : g), 0);
            b = d ? b + g : b;
            l.setStyle("height",
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, g = e.blockLimit, f = a.data.selection, r = f.getRanges()[0], h;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if (f = d(f, e)) f.appendBogus(), h = CKEDITOR.env.ie && !CKEDITOR.env.edge || CKEDITOR.env.edge && b._.previousActive;
            k(b, e.block, g) && r.collapsed && !r.getCommonAncestor().isReadOnly() && (e = r.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), g = new CKEDITOR.dom.walker(e), g.guard = function (a) {
                return !c(a) || a.type == CKEDITOR.NODE_COMMENT || a.isReadOnly()
            },
            !g.checkForward() || e.checkStartOfBlock() && e.checkEndOfBlock()) && (b = r.fixBlock(!0, b.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p"), CKEDITOR.env.needsBrFiller || (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), h = 1, a.cancel());
            h && r.select()
        }
            ...
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    b.startContainer.type == CKEDITOR.NODE_ELEMENT && (b.startContainer.is({
                        ...
                        thead: 1,
                        tfoot: 1
                    }) ? H(b) : b.startContainer.is(CKEDITOR.dtd.$list) && u(b));
                    var f, D;
                    if (g) for (; (f = b.getCommonAncestor(0, 1)) && (D = CKEDITOR.dtd[f.getName()]) && (!D || !D[e]);) if (f.getName() in
                        CKEDITOR.dtd.span) {
                        var g = b.splitElement(f), h = b.createBookmark();
                        l(f);
                        l(g);
                        b.moveToBookmark(h)
                    } else b.checkStartOfBlock() && b.checkEndOfBlock() ? (b.setStartBefore(f), b.collapse(!0), f.remove()) : b.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                    b.insertNode(a);
                    return !0
                ...
                fixInitialSelection: function () {
                    ...
                    var c = J, d = {range: a, doc: a.document}, e = this.getHtmlFromRange(a);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (k) {
                            var h = f.getHead(), r = h.getCustomData("stylesheet");
                            r ? k != r.getText() && (CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? r.$.styleSheet.cssText = k : r.setText(k)) : (k = f.appendStyleText(k), k = new CKEDITOR.dom.element(k.ownerNode || k.owningElement), h.setCustomData("stylesheet", k), k.data("cke-temp", 1))
                        }
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (0 !== b.getRanges().length) {
                                if (c in B) {
                                    var g, f = b.getRanges()[0], h = f.startPath(), r, k, l, c = 8 == c;
                                    CKEDITOR.env.ie &&
                        ...
                        this.attachListener(this, "keyup", function (b) {
                            b.data.getKeystroke() in B && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select())
                        });
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                            ...
                            if (c in B && (b = a.getSelection(), 0 !== b.getRanges().length)) {
                                ...
                                } else c = d, h = b.block, d = c.endPath().block, h && d && !h.equals(d) ? (a.fire("saveSnapshot"), (e = h.getBogus()) && e.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(h, !1), b.lastElement.mergeSiblings(), g(h, d, !0)), c = a.getSelection().getRanges()[0], c.collapse(1), c.optimize(), "" === c.startContainer.getHtml() && c.startContainer.appendBogus(), c.select(), b = !0) : b = !1;
                                if (!b) return;
        ...
        n = function () {
            ...
            function b(c, d) {
                var e, g, f, h, r = [], k = d.range.startContainer;
                e = d.range.startPath();
                for (var k = D[k.getName()], B = 0, w = c.getChildren(), l = w.count(), q = -1, n = -1, Q = 0, A = e.contains(D.$list); B <
                l; ++B) e = w.getItem(B), a(e) ? (f = e.getName(), A && f in CKEDITOR.dtd.$list ? r = r.concat(b(e, d)) : (h = !!k[f], "br" != f || !e.data("cke-eol") || B && B != l - 1 || (Q = (g = B ? r[B - 1].node : w.getItem(B + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && D.$block[g.getName()]), -1 != q || h || (q = B), h || (n = B), r.push({
                    isElement: 1,
                    isLineBreak: Q,
                    ...
                    name: f,
                    allowed: h
                }), g = Q = 0)) : r.push({isElement: 0, node: e, allowed: 1});
                -1 < q && (r[q].firstNotAllowed = 1);
            ...
            function d(b, c) {
                var e = [],
                    g = b.getChildren(), f = g.count(), h, r = 0, k = D[c], B = !b.is(D.$inline) || b.is("br");
                for (B && e.push(" "); r < f; r++) h = g.getItem(r), a(h) && !h.is(k) ? e = e.concat(d(h, c)) : e.push(h);
                B && e.push(" ");
                return e
            }
            ...
            function f(b, c, d, e) {
                ...
                (h = (new CKEDITOR.dom.walker(g)).next()) && a(h) && w[h.getName()] &&
            ...
            var D = CKEDITOR.dtd, w = {
                p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1,
                h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1
            }, q = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, n = CKEDITOR.tools.extend({}, D.$inline);
            delete n.br;
            return function (t, w, N, p) {
                var G = t.editor, F = !1, y;
                "unfiltered_html" == w && (w = "html", F = !0);
                if (!p.checkReadOnly()) {
                    var z = (new CKEDITOR.dom.elementPath(p.startContainer, p.root)).blockLimit || p.root;
                    w = {
                        type: w,
                        dontFilter: F,
                        editable: t,
                    ...
                    var F = w.range, z = w.mergeCandidates, x = "html" === w.type, u, E, T, H, Z;
                    "text" == w.type &&
                    F.shrink(CKEDITOR.SHRINK_ELEMENT, !0, !1) && (E = CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e", F.document), F.insertNode(E), F.setStartAfter(E));
                    T = new CKEDITOR.dom.elementPath(F.startContainer);
                    w.endPath = H = new CKEDITOR.dom.elementPath(F.endContainer);
                    if (!F.collapsed) {
                        u = H.block || H.blockLimit;
                        var ca = F.getCommonAncestor();
                        u && !u.equals(ca) && !u.contains(ca) && F.checkEndOfBlock() && w.zombies.push(u);
                        F.deleteContents()
                    }
                    for (; (Z = e(F)) && a(Z) && Z.isBlockBoundary() && T.contains(Z);) F.moveToPosition(Z,
                        CKEDITOR.POSITION_BEFORE_END);
                    f(F, w.blockLimit, T, H);
                    E && (F.setEndBefore(E), F.collapse(), E.remove());
                    E = F.startPath();
                    if (u = E.contains(g, !1, 1)) y = F.splitElement(u), w.inlineStylesRoot = u, w.inlineStylesPeak = E.lastElement;
                    E = F.createBookmark();
                    x && (l(u), l(y));
                    (u = E.startNode.getPrevious(c)) && a(u) && g(u) && z.push(u);
                    (u = E.startNode.getNext(c)) && a(u) && g(u) && z.push(u);
                    for (u = E.startNode; (u = u.getParent()) && g(u);) z.push(u);
                    F.moveToBookmark(E);
                    y = t.getHtml();
                    y = "" === y || y.match(v);
                    G.enterMode === CKEDITOR.ENTER_DIV && y && ((G =
                        t.getFirst()) && G.remove(), p.setStartAt(t, CKEDITOR.POSITION_AFTER_START), p.collapse(!0));
                    if (t = N) {
                        t = w.range;
                        if ("text" == w.type && w.inlineStylesRoot) {
                            p = w.inlineStylesPeak;
                            G = p.getDocument().createText("{cke-peak}");
                            for (y = w.inlineStylesRoot.getParent(); !p.equals(y);) G = G.appendTo(p.clone()), p = p.getParent();
                            N = G.getOuterHtml().split("{cke-peak}").join(N)
                        }
                        p = w.blockLimit.getName();
                        if (/^\s+|\s+$/.test(N) && "span" in CKEDITOR.dtd[p]) {
                        ...
                        if ((V = t.startPath().block) && (1 != V.getChildCount() || !V.getBogus())) a:{
                            var P;
                            if (1 == p.getChildCount() && a(P = p.getFirst()) && P.is(q) && !P.hasAttribute("contenteditable")) {
                                V = P.getElementsByTag("*");
                                t = 0;
                                for (y = V.count(); t < y; t++) if (G = V.getItem(t), !G.is(n)) break a;
                    ...
                    if (t) {
                        ...
                        var R, V = [], I, M;
                        N = E = 0;
                        var J, G = P.startContainer;
                        Z = w.endPath.elements[0];
                        var ba, F = Z.getPosition(G),
                            z = !!Z.getCommonAncestor(G) && F != CKEDITOR.POSITION_IDENTICAL && !(F & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED),
                            G = b(w.dataWrapper, w);
                        for (w.editor.enterMode !== CKEDITOR.ENTER_BR && B(G, P); y < G.length; y++) {
                            F = G[y];
                            if (x = F.isLineBreak) x = P, u = p, H = T = void 0, F.hasBlockSibling ? x = 1 : (T = x.startContainer.getAscendant(D.$block, 1)) &&
                            T.is({
                                div: 1,
                                p: 1
                            }) ? (H = T.getPosition(u), H == CKEDITOR.POSITION_IDENTICAL || H == CKEDITOR.POSITION_CONTAINS ? x = 0 : (u = x.splitElement(T), x.moveToPosition(u, CKEDITOR.POSITION_AFTER_START), x = 1)) : x = 0;
                            if (x) N = 0 < y; else {
                                x = P.startPath();
                                !F.isBlock && k(w.editor, x.block, x.blockLimit) && (M = h(w.editor)) && (M = t.createElement(M), M.appendBogus(), P.insertNode(M), CKEDITOR.env.needsBrFiller && (R = M.getBogus()) && R.remove(), P.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END));
                                ...
                                if (E && F.isElement) {
                                    x = P.startContainer;
                                    for (u = null; x && !D[x.getName()][F.name];) {
                                        if (x.equals(p)) {
                                            x = null;
                                            break
                                        }
                                    ...
                                    if (x) u && (J = P.splitElement(u), w.zombies.push(J), w.zombies.push(u)); else {
                                        u = p.getName();
                                        ba = !y;
                                        x = y == G.length - 1;
                                        u = d(F.node, u);
                                        T = [];
                                        H = u.length;
                                        for (var ca = 0, ea = void 0, X = 0, W = -1; ca < H; ca++) ea = u[ca], " " == ea ? (X || ba && !ca || (T.push(new CKEDITOR.dom.text(" ")), W = T.length), X = 1) : (T.push(ea), X = 0);
                                        x && W == T.length && T.pop();
                                        ba = T
                                    }
                                }
                                if (ba) {
                                    ...
                                    ba = 0
                                } else P.insertNode(F.node);
                                F.lastNotAllowed && y < G.length - 1 && ((J = z ? Z : J) && P.setEndAt(J, CKEDITOR.POSITION_AFTER_START), E = 0);
                                P.collapse()
                            }
                        }
                        1 != G.length ? R = !1 : (R = G[0], R = R.isElement && "false" == R.node.getAttribute("contenteditable"));
                        R && (N = !0, x = G[0].node, P.setStartAt(x, CKEDITOR.POSITION_BEFORE_START), P.setEndAt(x, CKEDITOR.POSITION_AFTER_END));
                        w.dontMoveCaret = N;
                    ...
                    for (I = R.createBookmark(); M = w.zombies.pop();) M.getParent() && (J = R.clone(), J.moveToElementEditStart(M),
                        J.removeEmptyBlocksAtEnd());
                    if (ba) for (; M = ba.pop();) CKEDITOR.env.needsBrFiller ? M.appendBogus() : M.append(R.document.createText(" "));
                    for (; M = w.mergeCandidates.pop();) M.mergeSiblings();
                    CKEDITOR.env.webkit && R.startPath() && (M = R.startPath(), M.block ? M.block.$.normalize() : M.blockLimit && M.blockLimit.$.normalize());
                    R.moveToBookmark(I);
                    if (!w.dontMoveCaret) {
                        for (M = e(R); M && a(M) && !M.is(D.$empty);) {
                            if (M.isBlockBoundary()) R.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END); else {
                                ...
                                Y = R.clone();
                                Y.moveToPosition(M, CKEDITOR.POSITION_BEFORE_END)
                            }
                            M = M.getLast(c)
                        }
                        Y && R.moveToRange(Y)
        ...
        H = function () {
            ...
            function c(a) {
                var b = a.count(), d;
                for (b; 0 < b--;) d = a.getItem(b), CKEDITOR.tools.trim(d.getHtml()) ||
        ...
        I = {
            eol: {
                ...
                exclude: function (a) {
                    ...
                    !b || !E(b) || c && c.equals(b) || a.range.setEndBefore(b)
                }
            }, tree: {
                ...
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark),
                            e = d.startPath(), g = d.endPath(), f = e.contains(CKEDITOR.dtd.$list),
                    ...
                    function a(c) {
                        ...
                        f.guard = function (a,
                                            f) {
                            if (a.type == CKEDITOR.NODE_ELEMENT) {
                                var q = "visited_" + (f ? "out" : "in");
                                if (a.getCustomData(q)) return;
                                CKEDITOR.dom.element.setMarker(l, a, q, 1)
                            }
                            if (f && h && a.equals(h)) g = c.clone(), g.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(g); else if (!f && k && a.equals(k)) g = c.clone(), g.setStartAt(k, CKEDITOR.POSITION_AFTER_START), e.push(g); else {
                                if (q = !f) q = a.type == CKEDITOR.NODE_ELEMENT && a.is(d) && (!h || b(a, h)) && (!k || b(a, k));
                                if (!q && (q = f)) if (a.is(d)) var q = h && h.getAscendant("table", !0),
                                    m = k && k.getAscendant("table", !0), n = a.getAscendant("table",
                                        !0), q = q && q.contains(n) || m && m.contains(n); else q = void 0;
                                q && (g = c.clone(), g.selectNodeContents(a), e.push(g))
                            }
                        };
                        f.lastForward();
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var f = c(g, e.bookmark), h = f.clone(), k, t, l = f.getCommonAncestor();
                            l.is(CKEDITOR.dtd.$tableContent) && !l.is(d) && (l = l.getAscendant("table", !0));
                            t = l;
                            l = new CKEDITOR.dom.elementPath(f.startContainer,
                                t);
                            t = new CKEDITOR.dom.elementPath(f.endContainer, t);
                            l = l.contains("table");
                            t = t.contains("table");
                            if (l || t) l && t && b(l, t) ? (e.tableSurroundingRange = h, h.setStartAt(l, CKEDITOR.POSITION_AFTER_END), h.setEndAt(t, CKEDITOR.POSITION_BEFORE_START), h = f.clone(), h.setEndAt(l, CKEDITOR.POSITION_AFTER_END), k = f.clone(), k.setStartAt(t, CKEDITOR.POSITION_BEFORE_START), k = a(h).concat(a(k))) : l ? t || (e.tableSurroundingRange = h, h.setStartAt(l, CKEDITOR.POSITION_AFTER_END), f.setEndAt(l, CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange =
    ...
    (function () {
        ...
        function e() {
            ...
            if (b) {
                ...
                if (!(e = !c) && (e = !c.isHidden())) {
                    e = b;
                    var g = c.getRanges(), f = e.getRanges(),
                    ...
                    if (a(e.getSelectedElement())) e = !1; else {
                        ...
                        h && (p || f) ? (l && !N && e.selectRanges(g), e = !0) : e = !1
                    }
                    e = !e
                }
                e && (b.reset(), b = 0)
        ...
        function h() {
            m = null;
            C && (CKEDITOR.tools.setTimeout(e, 0, this), C = !1)
        }
        ...
        function E(a) {
            ...
            return function (c) {
                ...
                if (b[d]) {
                    var e = a.getSelection(), g = e.getRanges()[0];
        ...
        var n =
                "function" != typeof window.getSelection, H = 1, u = CKEDITOR.tools.repeat("​", 7),
            I = new RegExp(u + "( )?", "g"), J, m, C, K = CKEDITOR.dom.walker.invisible(1), A = function () {
                function a(b) {
                    return function (a) {
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            c.on("contentDom", function () {
                function a() {
                    B = new CKEDITOR.dom.selection(c.getSelection());
                    B.lock()
                }
                ...
                var f = c.document, h = CKEDITOR.document, p = c.editable(), l = f.getBody(),
                    r = f.getDocumentElement(), q = p.isInline(), m, B;
                CKEDITOR.env.gecko && p.attachListener(p, "focus", function (a) {
                    a.removeListener();
                    0 !== m && (a = c.getSelection().getNative()) && a.isCollapsed && a.anchorNode == p.$ && (a = c.createRange(), a.moveToElementEditStart(p), a.select())
                }, null, null, -2);
                p.attachListener(p, CKEDITOR.env.webkit || CKEDITOR.env.gecko ? "focusin" : "focus", function () {
                    if (m && (CKEDITOR.env.webkit ||
                        ...
                        CKEDITOR.env.webkit && m && a && (p.$.scrollTop = c._.previousScrollTop)
                    }
                    c.unlockSelection(m);
                    m = 0
                }, null, null, -1);
                ...
                if (CKEDITOR.env.ie || CKEDITOR.env.gecko || q) n ? p.attachListener(p, "beforedeactivate", a, null, null, -1) : p.attachListener(c, "selectionCheck", a, null, null, -1), p.attachListener(p, CKEDITOR.env.webkit || CKEDITOR.env.gecko ?
                    "focusout" : "blur", function () {
                    var a = B && (B.isFake || 2 > B.getRanges().length);
                    CKEDITOR.env.gecko && !q && a || (c.lockSelection(B), m = 1)
                ...
                if (CKEDITOR.env.ie && !q) {
                    ...
                    if ("BackCompat" != f.$.compatMode) {
                            ...
                            r.on("mousedown", function (a) {
                                function b(a) {
                                    ...
                                    if (z) {
                                        ...
                                        z.setEndPoint(0 > u.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
                                        z.select()
                                    }
                                }
                                ...
                                a = a.data;
                                if (a.getTarget().is("html") && a.$.y < r.$.clientHeight &&
                                    a.$.x < r.$.clientWidth) {
                                    z = l.$.createTextRange();
                                    try {
                        ...
                        if (7 < CKEDITOR.env.version && 11 > CKEDITOR.env.version) r.on("mousedown", function (a) {
                            a.data.getTarget().is("html") && (h.on("mouseup", b), r.on("mouseup", b))
                        })
                    }
                }
                ...
                p.attachListener(p, "keydown", E(c), null, null, -1)
            });
        ...
        CKEDITOR.dom.selection = function (a) {
            ...
            a = this.getNative();
            var d, e;
            if (a) if (a.getRangeAt) d = (e = a.rangeCount && a.getRangeAt(0)) &&
                new CKEDITOR.dom.node(e.commonAncestorContainer); else {
                try {
                    e = a.createRange()
                } catch (g) {
                }
            ...
            getNative: function () {
                ...
                var a = n ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, g, f, h = b.duplicate(), k = 0, l = e.length - 1, r = -1, q, m; k <= l;) if (r = Math.floor((k + l) / 2), g = e[r], h.moveToElementText(g), q = h.compareEndPoints("StartToStart",
                            b), 0 < q) l = r - 1; else if (0 > q) k = r + 1; else return {container: d, offset: a(g)};
                        if (-1 == r || r == e.length - 1 && 0 > q) {
                            ...
                            for (d = e.length; 0 < h && 0 < d;) f = e[--d], f.nodeType == CKEDITOR.NODE_TEXT && (m = f, h -= f.nodeValue.length);
                        ...
                        h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                        if (!h) return {container: d, offset: a(g) + (0 < q ? 0 : 1)};
                        for (; 0 < h;) try {
                            f = g[0 < q ? "previousSibling" : "nextSibling"], f.nodeType == CKEDITOR.NODE_TEXT && (h -= f.nodeValue.length, m = f), g = f
                        } catch (n) {
                ...
                var b = this, c = CKEDITOR.tools.tryThese(function () {
                    ...
                    for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) &&
                        c.type == CKEDITOR.NODE_ELEMENT && L[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
                    return d && d.$
                });
                ...
                if (a && a._.fakeSelection) if (this.rev ==
                ...
                if (a.length) if (this.isLocked) {
                    ...
                    a:{
                        var l, m;
                        if (1 == a.length && !(m = a[0]).collapsed && (t = m.getEnclosedNode()) && t.type == CKEDITOR.NODE_ELEMENT && (m = m.clone(), m.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = m.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT &&
                    ...
                    if (t) this.fake(t); else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment(b) && d(a) && !J && !a[0]._getTableElement({table: 1}).hasAttribute("data-cke-tableselection-ignored")) f.call(this, a); else {
                        if (n) {
                            ...
                            if ((c = b.getEnclosedNode()) &&
                                c.type == CKEDITOR.NODE_ELEMENT && c.getName() in L && (!c.is("a") || !c.getText())) try {
                                F = c.$.createControlRange();
                                F.addElement(c.$);
                                F.select();
                                return
                            } catch (x) {
                            ...
                            for (F = 0; F < a.length; F++) {
                                if (F < a.length - 1 && (p = a[F], G = a[F + 1], t = p.clone(), t.setStart(p.endContainer, p.endOffset), t.setEnd(G.startContainer, G.startOffset), !t.collapsed && (t.shrink(CKEDITOR.NODE_ELEMENT, !0), b = t.getCommonAncestor(), t = t.getEnclosedNode(), b.isReadOnly() || t && t.isReadOnly()))) {
                                    G.setStart(p.startContainer, p.startOffset);
                                    a.splice(F--,
                                        1);
                                    continue
                                }
                                ...
                                b.collapsed && CKEDITOR.env.webkit && q(b) && (t = g(this.root), b.insertNode(t), (p = t.getNext()) && !t.getPrevious() && p.type == CKEDITOR.NODE_ELEMENT && "br" == p.getName() ? (y(this.root), b.moveToPosition(p, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(t, CKEDITOR.POSITION_AFTER_END));
    ...
    (function () {
        ...
        function b(c) {
            ...
            if (c.collapsed) e = H(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                c.trim();
                var n = c.createBookmark(), y = n.startNode, x = n.endNode, r = y, z;
                if (!l) {
                    var u = c.getCommonAncestor(), l = a(y, u), u = a(x, u);
                    l && (r = l.getNextSourceNode(!0));
                    u && (x = u)
                }
                for (r.getPosition(x) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    l = !1;
                    if (r.equals(x)) r = null, l = !0; else {
                        var v = r.type == CKEDITOR.NODE_ELEMENT ? r.getName() : null,
                            ...
                            w = v && (r.getAttribute("data-nostyle") || w);
                        if (v && r.data("cke-bookmark") || r.type === CKEDITOR.NODE_COMMENT) {
                            r = r.getNextSourceNode(!0);
                            continue
                        }
                        if (u && m && CKEDITOR.dtd.$block[v]) for (var A = r, B = f(A), C = void 0, I = B.length, J = 0, A = I && new CKEDITOR.dom.range(A.getDocument()); J < I; ++J) {
                            var C = B[J], K = CKEDITOR.filter.instances[C.data("cke-filter")];
                            if (K ? K.check(this) : 1) A.selectNodeContents(C), b.call(this, A)
                        }
                        B = v ? !q[v] || w ? 0 : u && !m ? 0 : d(r, x, h, Q) : 1;
                        if (B) if (C =
                            r.getParent(), B = h, I = g, J = k, !C || !(C.getDtd() || CKEDITOR.dtd.span)[I] && !J || B.parentRule && !B.parentRule(C)) l = !0; else {
                            if (z || v && CKEDITOR.dtd.$removeEmpty[v] && (r.getPosition(x) | Q) != Q || (z = c.clone(), z.setStartBefore(r)), v = r.type, v == CKEDITOR.NODE_TEXT || u || v == CKEDITOR.NODE_ELEMENT && !r.getChildCount()) {
                                for (var v = r, L; (l = !v.getNext(D)) && (L = v.getParent(), q[L.getName()]) && d(L, y, h, S);) v = L;
                                z.setEndAfter(v)
                            }
                        } else l = !0;
                    ...
                    if (l && z && !z.collapsed) {
                        for (var l = H(this, e), u = l.hasAttributes(), w = z.getCommonAncestor(),
                                 v = {}, B = {}, C = {}, I = {}, X, W, Y; l && w;) {
                            if (w.getName() == g) {
                                for (X in h.attributes) !I[X] && (Y = w.getAttribute(W)) && (l.getAttribute(X) == Y ? B[X] = 1 : I[X] = 1);
                                for (W in h.styles) !C[W] && (Y = w.getStyle(W)) && (l.getStyle(W) == Y ? v[W] = 1 : C[W] = 1)
                            }
                            w = w.getParent()
                        }
                        for (X in B) l.removeAttribute(X);
                        for (W in v) l.removeStyle(W);
                        u && !l.hasAttributes() && (l = null);
                        l ? (z.extractContents().appendTo(l), z.insertNode(l), E.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), z.extractContents().appendTo(l),
                            z.insertNode(l), E.call(this, l), l.remove(!0));
                        z = null
                    }
                }
                c.moveToBookmark(n);
        ...
        function c(a) {
            ...
            if (a.collapsed) {
                ...
                var m = c.endNode, q = this;
                b();
                for (g = d; !g.equals(m);) f = g.getNextSourceNode(), g.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(g) && (g.getName() == this.element ? x.call(this, g) : v(g, J(this)[g.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) &&
                (b(), f = d.getNext())), g = f
            }
            a.moveToBookmark(c);
        ...
        function h(a) {
            ...
            for (var d, e = a.document, g; d = c.getNextParagraph();) !d.isReadOnly() && (c.activeFilter ? c.activeFilter.check(this) : 1) && (g = H(this, e, d), q(d, g));
            a.moveToBookmark(b)
        }
        ...
        function q(a, b) {
            ...
            if (d && !e) {
                ...
                b = e
            } else f ? b = z(c ? [a.getHtml()] : g(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b, k;
                (k = c.getPrevious(w)) &&
        ...
        function x(a, b) {
            var c = this._.definition, d = c.attributes, c = c.styles, e = J(this)[a.getName()],
                g = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), f;
            for (f in d) if ("class" != f && !this._.definition.fullMatch || a.getAttribute(f) == m(f, d[f])) b && "data-" == f.slice(0, 5) || (g = a.hasAttribute(f), a.removeAttribute(f));
            for (var h in c) this._.definition.fullMatch && a.getStyle(h) != m(h, c[h], !0) || (g = g || !!a.getStyle(h), a.removeStyle(h));
            v(a, e, A[a.getName()]);
            g && (this._.definition.alwaysRemoveElement ? n(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? n(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
        }

        function E(a) {
            for (var b = J(this), c = a.getElementsByTag(this.element), d, e = c.count(); 0 <= --e;) d = c.getItem(e), d.isReadOnly() || x.call(this, d, !0);
            for (var g in b) if (g != this.element) for (c = a.getElementsByTag(g), e = c.count() - 1; 0 <= e; e--) d = c.getItem(e), d.isReadOnly() || v(d, b[g])
        }
        ...
        var A = {
                ...
                audio: 1,
                video: 1
            }, r = /\s*(?:;\s*|$)/, B = /#\((.+?)\)/g, D = CKEDITOR.dom.walker.bookmark(0, 1),
        ...
        CKEDITOR.style = function (a, b) {
            ...
            c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() :
                a.element : "*";
            this.type = a.type || (A[c] ? CKEDITOR.STYLE_BLOCK : L[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
        ...
        CKEDITOR.style.prototype = {
            apply: function (a) {
                ...
                if (a instanceof
                    CKEDITOR.dom.document) return K.call(this, a.getSelection(), 1);
                if (this.checkApplicable(a.elementPath(), a)) {
                    var b = this._.enterMode;
                    b || (this._.enterMode = a.activeEnterMode);
    ...
    (function () {
        ...
        CKEDITOR.dom.selection.prototype.optimizeInElementEnds = function () {
            var b = this.getRanges()[0], f = this.root.editor, e;
    ...
    (function () {
        function a(a, c) {
            if (b(a)) a = Math.round(c * (parseFloat(a) / 100)); else if ("string" === typeof a && a.match(/^\d+$/gm) || "string" === typeof a && a.match(/^\d+(?:deg)?$/gm)) a = parseInt(a, 10);
            return a
        }
                ...
                $: function (a, b) {
                    ...
                    extractColorChannelsFromRgba: function (b) {
                        ...
                        var l = a(c[1], CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE),
                            q = a(c[2], CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE), g = 1;
                        f && (g = d(c[3], CKEDITOR.tools.color.MAX_ALPHA_CHANNEL_VALUE));
                        c = {type: CKEDITOR.tools.color.TYPE_RGB, red: b, green: l, blue: q, alpha: g};
                        return this._.areColorChannelsValid(b, l, q, g) ? c : null
                    },
                    extractColorChannelsFromHsla: function (b) {
                        ...
                        var f = 4 === c.length, l = a(c[0], CKEDITOR.tools.color.MAX_HUE_CHANNEL_VALUE),
                            q = d(c[1], CKEDITOR.tools.color.MAX_SATURATION_LIGHTNESS_CHANNEL_VALUE),
                            g = d(c[2], CKEDITOR.tools.color.MAX_SATURATION_LIGHTNESS_CHANNEL_VALUE), y = 1;
                        b = this._.hslToRgb(l, q, g);
                        f && (y = d(c[3], CKEDITOR.tools.color.MAX_ALPHA_CHANNEL_VALUE));
                        b.push(y);
                        c = {
                    ...
                    extractColorChannelsByPattern: function (a, b) {
                        var c = a.match(b);
                        if (!c) return null;
                        var d = -1 === c[1].indexOf(",") ? /\s/ : ",", d = c[1].split(d),
                    ...
                    rgbToHsl: function (a, b, c) {
                        ...
                        var d = c / CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE, f = Math.max(a, b, d),
                            g = Math.min(a, b, d);
                        c = f - g;
                        var y = 0;
                        switch (f) {
    ...
    (function () {
        ...
        CKEDITOR.dom.elementPath = function (b, f) {
            ...
            do if (l.type == CKEDITOR.NODE_ELEMENT) {
                ...
                if (l.equals(f)) break;
                if (!k && (q = l.getName(),
                    "true" == l.getAttribute("contenteditable") ? k = l : !e && d[q] && (e = l), a[q])) {
                    if (q = !e && "div" == q) {
                        a:{
                            q = l.getChildren();
                            for (var g = 0, y = q.count(); g < y; g++) {
                                var z = q.getItem(g);
    ...
    CKEDITOR.dom.elementPath.prototype = {
        compare: function (a) {
            ...
            var e = this.elements, k = e.length;
            d && (b ? c += 1 : --k);
    ...
    (function () {
        function a(a, c, d) {
            var e = a.serializable, k = c[d ? "endContainer" : "startContainer"], h = d ? "endOffset" : "startOffset",
                ...
                return {
                    getNextRange: function (k) {
                        ...
                        if (h && 1 < a.length) {
                            ...
                            if (k) for (var q = 0; a[e + q + 1];) {
                                var g = h.document;
                                k = 0;
                                l = g.getById(d[q].endNode);
                                for (g = g.getById(d[q + 1].startNode); ;) {
                                    l =
                                        l.getNextSourceNode(!1);
                                    if (g.equals(l)) k = 1; else if (c(l) || l.type == CKEDITOR.NODE_ELEMENT && l.isBlockBoundary()) continue;
                                    break
                                }
                                if (!k) break;
                                q++
    ...
    (function () {
        ...
        var k = "cke_ui_color", h = [], l = /\$color/g;
...
*/
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
                            for (var e = [], d = [], g = (a.id ? a.id : CKEDITOR.tools.getNextId()) + "_radio", k = 0; k < a.items.length; k++) {
                                var l = a.items[k], h = void 0 !== l[2] ? l[2] : l[0],
                                    n = void 0 !== l[1] ? l[1] : l[0], p = CKEDITOR.tools.getNextId() + "_radio_input",
                                    q = p + "_label",
                ...
                getInputElement: function () {
                    ...
                    function b() {
                        ...
                        d.$.write(['\x3chtml dir\x3d"' + g + '" lang\x3d"' + k + '"\x3e\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e\x3cbody style\x3d"margin: 0; overflow: hidden; background: transparent;"\x3e',
                            ...
                            CKEDITOR.env.ie ? "(" + CKEDITOR.tools.fixDomain + ")();" : "", "window.parent.CKEDITOR.tools.callFunction(" + e + ");", "window.onbeforeunload \x3d function() {window.parent.CKEDITOR.tools.callFunction(" + m + ")}", "\x3c/script\x3e"].join(""));
                        d.$.close();
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, a, d || {type: "vbox"}, e, "div", null, {role: "presentation"}, function () {
                            ...
                            for (var e = 0; e < c.length; e++) {
                                ...
                                h ? k.push("height:" +
                                    y(h[e])) : d && d.expand && k.push("height:" + Math.floor(100 / c.length) + "%");
    ...
    (function () {
        ...
        function x(a) {
            ...
            function c(b) {
                return {
                    ...
                    exec: function () {
                        ...
                        var b;
                        var c = this.type;
                        if (CKEDITOR.env.ie) b = f(c); else try {
                ...
                return {
                    ...
                    async: !0, fakeKeystroke: CKEDITOR.CTRL + 86, exec: function (a, b) {
                        function c(b, h) {
                            ...
                            b ? (b.method = "paste", b.dataTransfer || (b.dataTransfer = n.initPasteDataTransfer()), u(a, b, h)) : k && !a._.forcePasteDialog && a.showNotification(e, "info", a.config.clipboard_notificationDuration);
                            a._.forcePasteDialog = !1;
                            a.fire("afterCommandExec", {name: "paste", command: d, returnValue: !!b})
                        }

                        b = "undefined" !== typeof b && null !== b ? b : {};
                        var d = this, k = "undefined" !== typeof b.notification ? b.notification : !0, h = b.type,
                            f = CKEDITOR.tools.keystrokeToString(a.lang.common.keyboard,
                                a.getCommandKeystroke(this)),
                            e = "string" === typeof k ? k : a.lang.clipboard.pasteNotification.replace(/%1/, '\x3ckbd aria-label\x3d"' + f.aria + '"\x3e' + f.display + "\x3c/kbd\x3e"),
            ...
            function f(b) {
                var c =
                    a.document, d = c.getBody(), h = !1, k = function () {
                    h = !0
                };
                d.on(b, k);
            ...
            function l() {
                if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
                    var b = a.getSelection(), c, d, h;
                    b.getType() == CKEDITOR.SELECTION_ELEMENT && (c = b.getSelectedElement()) && (d = b.getRanges()[0], h = a.document.createText(""), h.insertBefore(c), d.setStartBefore(h), d.setEndAfter(c), b.selectRanges([d]), setTimeout(function () {
            ...
            function k(b, c) {
                var d = a.document, h = a.editable(), k = function (a) {
                    a.cancel()
                }, f;
                if (!d.getById("cke_pastebin")) {
                    var e = a.getSelection(), r = e.createBookmarks();
                    CKEDITOR.env.ie && e.root.fire("selectionchange");
                    var m = new CKEDITOR.dom.element(!CKEDITOR.env.webkit && !h.is("body") || CKEDITOR.env.ie ? "div" : "body", d);
                    m.setAttributes({id: "cke_pastebin", "data-cke-temp": "1"});
                    var g = 0, d = d.getWindow();
                    CKEDITOR.env.webkit ? (h.append(m), m.addClass("cke_editable"), h.is("body") || (g = "static" != h.getComputedStyle("position") ?
                        h : CKEDITOR.dom.element.get(h.$.offsetParent), g = g.getDocumentPosition().y)) : h.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(m);
                    m.setStyles({
                        position: "absolute",
                    ...
                    (g = m.getParent().isReadOnly()) ? (m.setOpacity(0), m.setAttribute("contenteditable", !0)) : m.setStyle("ltr" == a.config.contentsLangDirection ?
                        "left" : "right", "-10000px");
                    ...
                    var l = g.select();
                    CKEDITOR.env.ie && (f = h.once("blur", function () {
                        a.lockSelection(l)
                    }));
            ...
            function m(b) {
                ...
                d && n.canClipboardApiBeTrusted(c.dataTransfer, a) ? (b.data.preventDefault(), setTimeout(function () {
                    u(a, c)
                }, 0)) : k(b, function (b) {
            ...
            var n = CKEDITOR.plugins.clipboard, v = 0, p = 0;
            (function () {
                a.on("key", h);
                a.on("contentDom", b);
            ...
            a.getClipboardData = function (b, c) {
                ...
                !1 === r() && (a.removeListener("paste", d), a._.forcePasteDialog &&
                k && a.fire("pasteDialog") ? (a.on("pasteDialogCommit", h), a.on("dialogHide", function (a) {
                    a.removeListener();
        ...
        function D(a) {
            ...
            a.on("contentDom", function () {
                ...
                var f = a.editable(), l = CKEDITOR.plugins.clipboard.getDropTarget(a), k = a.ui.space("top"),
                    r = a.ui.space("bottom");
                ...
                f.attachListener(a, "dragstart", function (c) {
                    b.initDragDataTransfer(c, a)
                }, null, null, 2);
                f.attachListener(a, "dragstart", function () {
                ...
                f.attachListener(l, "drop", function (c) {
                    if (!c.data.$.defaultPrevented && (c.data.preventDefault(), !a.readOnly)) {
                        ...
                        if (!d.isReadOnly() || d.type == CKEDITOR.NODE_ELEMENT && d.is("html")) {
                            var d = b.getRangeAtDropPosition(c, a), k = b.dragRange;
                            d && e(c, k, d)
                        }
                    }
                }, null, null, 9999);
                f.attachListener(a, "drop", b.initDragDataTransfer, b, null, 1);
                f.attachListener(a, "drop", function (k) {
                    if (k = k.data) {
                        var f = k.dropRange, r = k.dragRange, e = k.dataTransfer;
                        e.getTransferType(a) == CKEDITOR.DATA_TRANSFER_INTERNAL ?
                            setTimeout(function () {
                                b.internalDrop(r, f, e, a)
                            }, 0) : e.getTransferType(a) == CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? c(r, f, e) : d(f, e)
                    }
                }, null, null, 9999)
            })
        }
        ...
        CKEDITOR.plugins.add("clipboard", {
            requires: "dialog,notification,toolbar", init: function (a) {
                function b(b) {
                    b = CKEDITOR.tools.array.map(b, function (a) {
                ...
                if ((CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || CKEDITOR.plugins.clipboard.isFileApiSupported) && a.config.clipboard_handleImages) {
                    var g = ["image/png", "image/jpeg",
                        "image/gif"], f = b(g), l;
                    a.on("paste", function (b) {
                        var d = b.data, h = d.dataTransfer;
                        if (!d.dataValue && c(b, h)) if (h = h.getFile(0), -1 === CKEDITOR.tools.indexOf(g, h.type)) a.showNotification(f, "info", a.config.clipboard_notificationDuration); else {
                ...
                a.on("paste", function (b) {
                    b = b.data;
                    var c = a._.nextPasteType || b.type, d = b.dataValue, f,
                    ...
                    if ("text" == c && "html" == f) d = w(a, d, e.get("plain-text")); else if (l && a.pasteFilter && !b.dontFilter || n) d = w(a, d, a.pasteFilter);
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            internalDrop: function (a, b, c, d) {
                var e = CKEDITOR.plugins.clipboard, g = d.editable(), f, l;
                d.fire("saveSnapshot");
                d.fire("lockSnapshot", {dontUpdate: 1});
                CKEDITOR.env.ie && 10 > CKEDITOR.env.version && this.fixSplitNodesAfterDrop(a, b, e.dragStartContainerChildCount, e.dragEndContainerChildCount);
            ...
            getRangeAtDropPosition: function (a, b) {
                ...
                if (document.caretRangeFromPoint && b.document.$.caretRangeFromPoint(d, e)) c = b.document.$.caretRangeFromPoint(d, e), f.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset),
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (l) {
                                ...
                                var t = b.document.$.elementFromPoint(d, e), n = new CKEDITOR.dom.element(t), v;
                                if (n.equals(b.editable()) || "html" == n.getName()) return g && g.startContainer && !g.startContainer.equals(b.editable()) ? g : null;
                                v = n.getClientRect();
                                d < v.left ? f.setStartAt(n, CKEDITOR.POSITION_AFTER_START) : f.setStartAt(n, CKEDITOR.POSITION_BEFORE_END);
                                f.collapse(!0)
                            }
                        } catch (u) {
                            return null
        ...
        CKEDITOR.plugins.clipboard.dataTransfer = function (a, b) {
            ...
            this._ = {
                ...
                types: [], data: {}, files: [], nativeHtmlCache: "", normalizeType: function (a) {
                    a = a.toLowerCase();
            ...
            b && (this.sourceEditor = b, this.setData("text/html", b.getSelectedHtml(1)), "Text" == p || this.getData("text/plain") || this.setData("text/plain", b.getSelection().getSelectedText()))
        };
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            getData: function (a, b) {
                ...
                if ("string" === typeof c) var e = c.indexOf("\x3c/html\x3e"), c = -1 !== e ? c.substring(0, e + 7) : c;
                return c
            }, setData: function (a, b) {
                a = this._.normalizeType(a);
                "text/html" == a ? (this._.data[a] = this._stripHtml(b), this._.nativeHtmlCache = b) : this._.data[a] = b;
                if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || "URL" == a || "Text" == a) if ("Text" == p && "Text" == a && (this.id = b), this._.fallbackDataTransfer.isRequired()) this._.fallbackDataTransfer.setData(a, b); else try {
                    this.$.setData(a,
                        b)
                } catch (c) {
                }
                ...
                var a = this.getTypes(), a = CKEDITOR.tools.array.filter(a, function (a) {
                ...
                function b(a) {
                    var b = new CKEDITOR.htmlParser, e, g;
            ...
            isRequired: function () {
                ...
                try {
                    ...
                    if (this._isUnsupportedMimeTypeError(g)) {
                        ...
                        var c = this._getFallbackTypeContent(), f = this._getFallbackTypeData();
                        f[a] = d;
                        try {
                            d = this._applyDataComment(c, f), e.setData(this._customDataFallbackType, d), this._dataTransfer._.nativeHtmlCache = d
                        } catch (l) {
                            d = ""
                        }
                    }
    ...
    (function () {
        function x(a) {
            function d(a) {
                ...
                h.attachListener(h, "keyup", function () {
                    var e = c.getElementsByTag(a);
                    b && (1 == e.count() && !e.getItem(0).getCustomData("retain") && CKEDITOR.tools.isEmpty(e.getItem(0).getAttributes()) && e.getItem(0).remove(1), b = !1)
                })
            }
            ...
            if (b && !b.isDetached()) {
                ...
                b.enterMode != CKEDITOR.ENTER_P ? d("p") : CKEDITOR.env.edge && 15 > CKEDITOR.env.version && b.enterMode != CKEDITOR.ENTER_DIV && d("div");
                ...
                (CKEDITOR.env.gecko || CKEDITOR.env.ie && "CSS1Compat" == b.document.$.compatMode) && this.attachListener(this, "keydown", function (a) {
                    ...
                    if (33 == c || 34 == c) if (CKEDITOR.env.ie) setTimeout(function () {
                        ...
                        var e = b.createRange();
                        e[33 == c ? "moveToElementEditStart" : "moveToElementEditEnd"](this);
                        e.select();
                        a.data.preventDefault()
                    }
                });
        ...
        function z() {
            ...
            if (8 <= CKEDITOR.document.$.documentMode) {
                ...
                var d = [], b;
                for (b in CKEDITOR.dtd.$removeEmpty) d.push("html.CSS1Compat " +
        ...
        CKEDITOR.plugins.add("wysiwygarea", {
            init: function (a) {
                ...
                a.addMode("wysiwyg", function (d) {
                    function b(b) {
                        b && b.removeListener();
                        if (!a.isDestroyed() && !a.isDetached() && (a.editable(new n(a, g.getFrameDocument().getBody())), a.setData(a.getData(1), d), v)) {
                            if (w) a.on("mode", c, {iframe: g, editor: a, callback: d});
                            a.on("mode", function () {
                                a.status = "ready"
                            });
                            f()
                    ...
                    function f() {
                        r = new MutationObserver(function (a) {
                            CKEDITOR.tools.array.forEach(a, e)
                        });
                        r.observe(a.config.observableParent,
                            {childList: !0, subtree: !0})
                    }

                    function e(a) {
                        "childList" === a.type && 0 !== a.addedNodes.length && CKEDITOR.tools.array.forEach(a.addedNodes, h)
                    }

                    function h(b) {
                        b.contains && b.contains(a.container.$) && (w ? q = !0 : l())
                    }
                    ...
                    function l() {
                        ...
                        a.editable(null);
                        c = new n(a, g.getFrameDocument().getBody());
                        a.editable(c);
                        a.status = "recreating";
                        a.setData(b, {callback: d, internal: !1, noSnapshot: !1})
                    }

                    var k = "document.open();" + (CKEDITOR.env.ie ? "(" + CKEDITOR.tools.fixDomain + ")();" : "") + "document.close();",
                        k = CKEDITOR.env.air ? "javascript:void(0)" : CKEDITOR.env.ie && !CKEDITOR.env.edge ? "javascript:void(function(){" + encodeURIComponent(k) + "}())" : "",
                        g = CKEDITOR.dom.element.createFromHtml('\x3ciframe src\x3d"' + k + '" frameBorder\x3d"0"\x3e\x3c/iframe\x3e');
                    g.setStyles({width: "100%", height: "100%"});
                    g.addClass("cke_wysiwyg_frame").addClass("cke_reset");
                    k = a.ui.space("contents");
                    k.append(g);
                    var u = CKEDITOR.env.ie && !CKEDITOR.env.edge || CKEDITOR.env.gecko;
                    if (u) g.on("load", b);
                    var m = a.title, p = a.fire("ariaEditorHelpLabel",
                            {}).label, q = !1, w = CKEDITOR.env.ie && 11 === CKEDITOR.env.version,
                        v = !!window.MutationObserver, r;
                    m && (CKEDITOR.env.ie && p && (m += ", " + p), g.setAttribute("title", m));
                    if (p) {
                        var m = CKEDITOR.tools.getNextId(),
                            t = CKEDITOR.dom.element.createFromHtml('\x3cspan id\x3d"' + m + '" class\x3d"cke_voice_label"\x3e' + p + "\x3c/span\x3e");
                        k.append(t, 1);
                        g.setAttribute("aria-describedby", m)
                    }
        ...
        n = CKEDITOR.tools.createClass({
            $: function () {
                ...
                this._.frameLoadedHandler = CKEDITOR.tools.addFunction(function (a) {
                    CKEDITOR.tools.setTimeout(x, 0, this, a)
                }, this);
                ...
                preserveIframe: !1, setData: function (a,
                    ...
                    if (d) this.setHtml(a), this.fixInitialSelection(), b.fire("dataReady"); else {
                        ...
                        b._.dataStore = {id: 1};
                        var c = b.config, f = c.fullPage, e = c.docType,
                            h = CKEDITOR.tools.buildStyleHtml(z()).replace(/<style>/, '\x3cstyle data-cke-temp\x3d"1"\x3e');
                        f || (h += CKEDITOR.tools.buildStyleHtml(b.config.contentsCss));
                        var l = c.baseHref ? '\x3cbase href\x3d"' + c.baseHref + '" data-cke-temp\x3d"1" /\x3e' : "";
                        ...
                        f ? (/<body[\s|>]/.test(a) || (a = "\x3cbody\x3e" + a), /<html[\s|>]/.test(a) || (a = "\x3chtml\x3e" + a + "\x3c/html\x3e"), /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, "$\x26\x3ctitle\x3e\x3c/title\x3e")) : a = a.replace(/<html[^>]*>/, "$\x26\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e"), l && (a = a.replace(/<head[^>]*?>/, "$\x26" + l)), a = a.replace(/<\/head\s*>/, h + "$\x26"), a = e + a) : a = c.docType + '\x3chtml dir\x3d"' + c.contentsLangDirection +
                            '" lang\x3d"' + (c.contentsLanguage || b.langCode) + '"\x3e\x3chead\x3e\x3ctitle\x3e' + this._.docTitle + "\x3c/title\x3e" + l + h + "\x3c/head\x3e\x3cbody" + (c.bodyId ? ' id\x3d"' + c.bodyId + '"' : "") + (c.bodyClass ? ' class\x3d"' + c.bodyClass + '"' : "") + "\x3e" + a + "\x3c/body\x3e\x3c/html\x3e";
                        ...
                        c = '\x3cscript id\x3d"cke_actscrpt" type\x3d"text/javascript"' +
                            (CKEDITOR.env.ie ? ' defer\x3d"defer" ' : "") + "\x3evar wasLoaded\x3d0;function onload(){if(!wasLoaded)window.parent.CKEDITOR \x26\x26 window.parent.CKEDITOR.tools.callFunction(" + this._.frameLoadedHandler + ",window);wasLoaded\x3d1;}" + (CKEDITOR.env.ie ? "onload();" : 'document.addEventListener("DOMContentLoaded", onload, false );') + "\x3c/script\x3e";
                        ...
                        l &&
                        CKEDITOR.env.ie && 10 > CKEDITOR.env.version && (c += '\x3cscript id\x3d"cke_basetagscrpt"\x3evar baseTag \x3d document.querySelector( "base" );baseTag.href \x3d baseTag.href;\x3c/script\x3e');
                    ...
                    a = this.editor;
                    var d = a.config, b = d.fullPage, c = b && a.docType, f = b && a.xmlDeclaration,
                    ...
                    this._.isLoadingData ? this._.isPendingFocus = !0 : n.baseProto.focus.call(this)
                }, detach: function () {
                    if (!this.preserveIframe) {
                        var a = this.editor, d = a.document, a = a.container.findOne("iframe.cke_wysiwyg_frame");
                        n.baseProto.detach.call(this);
                        this.clearCustomData(this._.expandoNumber);
                        d.getDocumentElement().clearCustomData();
                        CKEDITOR.tools.removeFunction(this._.frameLoadedHandler);
                        a && (a.clearCustomData(), (d = a.removeCustomData("onResize")) && d.removeListener(), a.isDetached() || a.remove())
                    }
                }
            }
        })
